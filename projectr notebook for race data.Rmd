...
dt=merge(trump[c(1:4)], mpe16rwvd9[c("county", "lead")], by.x = 4, by.y = 2, all.x = TRUE)
```
...
trumpsupport <- data.frame(state_names=uscounties$region, county_names=uscounties$subregion, dontrus=donts[1:3076])
