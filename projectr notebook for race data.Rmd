...
race = county_facts[-1,c(1:4, 11:17)]
...
race2 =data.frame(race$fips, race$area_name, race$sa,  race$Population, wpop, bpop,  napop, apop, pipop, mupop, lpop)
...
totals = c(totAs, totBl, totLa, totMu, totNa, totPi, totWh)
```

```{r}

#barplot of total number of voters by race
barplot(totals, col=rainbow(7), names.arg = c("Asian", "Black", "Latino", "Mixed", "Native", "Pacific", "White"), main = "Total Votes by race", xlab = 'Races', ylab = "Votes in Millions")

#Same barplot, but withput the white vote for a better view of the others
barplot(totals[-c(7)], col=rainbow(7), names.arg = c("Asian", "Black", "Latino", "Mixed", "Native", "Pacific"), main = "Total Votes by race, Excluding Whites", xlab = 'Races', ylab = "Votes in Millions")
```
